...
public class Constant {
    ...
    public static final String ADMINSALOONS = "Adminsaloons";
    public static final String ARGS_SALOON = "argsSaloon";
    ...
    public static final String ISSALON = "ISSALON";

    public static final String ADMINSALOONSID = "ADMINSALOONSID";
    public static final String ISADMINSALOONS = "ISADMINSALOONS";
